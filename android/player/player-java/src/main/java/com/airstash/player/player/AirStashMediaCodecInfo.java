...
public class AirStashMediaCodecInfo {
    private final static String TAG = "AirStashMediaCodecInfo";
    ...
    public static AirStashMediaCodecInfo setupCandidate(MediaCodecInfo codecInfo,
            String mimeType) {
        if (codecInfo == null
        ...
        AirStashMediaCodecInfo candidate = new AirStashMediaCodecInfo();
