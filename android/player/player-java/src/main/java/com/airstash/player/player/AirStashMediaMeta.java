...
public class AirStashMediaMeta {
    // media meta
    public static final String AIRSTASHM_KEY_FORMAT = "format";
    public static final String AIRSTASHM_KEY_DURATION_US = "duration_us";
    public static final String AIRSTASHM_KEY_START_US = "start_us";
    public static final String AIRSTASHM_KEY_BITRATE = "bitrate";
    public static final String AIRSTASHM_KEY_VIDEO_STREAM = "video";
    public static final String AIRSTASHM_KEY_AUDIO_STREAM = "audio";

    // stream meta
    public static final String AIRSTASHM_KEY_TYPE = "type";
    public static final String AIRSTASHM_VAL_TYPE__VIDEO = "video";
    public static final String AIRSTASHM_VAL_TYPE__AUDIO = "audio";
    public static final String AIRSTASHM_VAL_TYPE__UNKNOWN = "unknown";
    public static final String AIRSTASHM_KEY_LANGUAGE = "language";

    public static final String AIRSTASHM_KEY_CODEC_NAME = "codec_name";
    public static final String AIRSTASHM_KEY_CODEC_PROFILE = "codec_profile";
    public static final String AIRSTASHM_KEY_CODEC_LEVEL = "codec_level";
    public static final String AIRSTASHM_KEY_CODEC_LONG_NAME = "codec_long_name";
    public static final String AIRSTASHM_KEY_CODEC_PIXEL_FORMAT = "codec_pixel_format";

    // stream: video
    public static final String AIRSTASHM_KEY_WIDTH = "width";
    public static final String AIRSTASHM_KEY_HEIGHT = "height";
    public static final String AIRSTASHM_KEY_FPS_NUM = "fps_num";
    public static final String AIRSTASHM_KEY_FPS_DEN = "fps_den";
    public static final String AIRSTASHM_KEY_TBR_NUM = "tbr_num";
    public static final String AIRSTASHM_KEY_TBR_DEN = "tbr_den";
    public static final String AIRSTASHM_KEY_SAR_NUM = "sar_num";
    public static final String AIRSTASHM_KEY_SAR_DEN = "sar_den";
    // stream: audio
    public static final String AIRSTASHM_KEY_SAMPLE_RATE = "sample_rate";
    public static final String AIRSTASHM_KEY_CHANNEL_LAYOUT = "channel_layout";

    public static final String AIRSTASHM_KEY_STREAMS = "streams";
    ...
    public final ArrayList<AirStashStreamMeta> mStreams = new ArrayList<AirStashStreamMeta>();
    public AirStashStreamMeta mVideoStream;
    public AirStashStreamMeta mAudioStream;
    ...
    public static AirStashMediaMeta parse(Bundle mediaMeta) {
        if (mediaMeta == null)
            return null;

        AirStashMediaMeta meta = new AirStashMediaMeta();
        meta.mMediaMeta = mediaMeta;

        meta.mFormat = meta.getString(AIRSTASHM_KEY_FORMAT);
        meta.mDurationUS = meta.getLong(AIRSTASHM_KEY_DURATION_US);
        meta.mStartUS = meta.getLong(AIRSTASHM_KEY_START_US);
        meta.mBitrate = meta.getLong(AIRSTASHM_KEY_BITRATE);

        int videoStreamIndex = meta.getInt(AIRSTASHM_KEY_VIDEO_STREAM, -1);
        int audioStreamIndex = meta.getInt(AIRSTASHM_KEY_AUDIO_STREAM, -1);

        ArrayList<Bundle> streams = meta
                .getParcelableArrayList(AIRSTASHM_KEY_STREAMS);
        if (streams == null)
            return meta;
        ...
        for (Bundle streamBundle : streams) {
            ...
            AirStashStreamMeta streamMeta = new AirStashStreamMeta(index);
            streamMeta.mMeta = streamBundle;
            streamMeta.mType = streamMeta.getString(AIRSTASHM_KEY_TYPE);
            streamMeta.mLanguage = streamMeta.getString(AIRSTASHM_KEY_LANGUAGE);
            if (TextUtils.isEmpty(streamMeta.mType))
                continue;

            streamMeta.mCodecName = streamMeta.getString(AIRSTASHM_KEY_CODEC_NAME);
            streamMeta.mCodecProfile = streamMeta
                    .getString(AIRSTASHM_KEY_CODEC_PROFILE);
            streamMeta.mCodecLongName = streamMeta
                    .getString(AIRSTASHM_KEY_CODEC_LONG_NAME);
            streamMeta.mBitrate = streamMeta.getInt(AIRSTASHM_KEY_BITRATE);

            if (streamMeta.mType.equalsIgnoreCase(AIRSTASHM_VAL_TYPE__VIDEO)) {
                streamMeta.mWidth = streamMeta.getInt(AIRSTASHM_KEY_WIDTH);
                streamMeta.mHeight = streamMeta.getInt(AIRSTASHM_KEY_HEIGHT);
                streamMeta.mFpsNum = streamMeta.getInt(AIRSTASHM_KEY_FPS_NUM);
                streamMeta.mFpsDen = streamMeta.getInt(AIRSTASHM_KEY_FPS_DEN);
                streamMeta.mTbrNum = streamMeta.getInt(AIRSTASHM_KEY_TBR_NUM);
                streamMeta.mTbrDen = streamMeta.getInt(AIRSTASHM_KEY_TBR_DEN);
                streamMeta.mSarNum = streamMeta.getInt(AIRSTASHM_KEY_SAR_NUM);
                streamMeta.mSarDen = streamMeta.getInt(AIRSTASHM_KEY_SAR_DEN);

                if (videoStreamIndex == index) {
                    meta.mVideoStream = streamMeta;
                }
            } else if (streamMeta.mType.equalsIgnoreCase(AIRSTASHM_VAL_TYPE__AUDIO)) {
                streamMeta.mSampleRate = streamMeta
                        .getInt(AIRSTASHM_KEY_SAMPLE_RATE);
                streamMeta.mChannelLayout = streamMeta
                        .getLong(AIRSTASHM_KEY_CHANNEL_LAYOUT);
    ...
    public static class AirStashStreamMeta {
        public Bundle mMeta;
        ...
        public AirStashStreamMeta(int index) {
            mIndex = index;
        }
