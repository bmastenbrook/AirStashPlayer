...
@implementation AirStashFFOptions {
...
{
    AirStashFFOptions *options = [[AirStashFFOptions alloc] init];
    ...
    [options setFormatOptionValue:@"airstashplayer"          forKey:@"user-agent"];

    [options setCodecOptionIntValue:AIRSTASH_AVDISCARD_ALL       forKey:@"skip_loop_filter"];
    [options setCodecOptionIntValue:AIRSTASH_AVDISCARD_NONREF    forKey:@"skip_frame"];
...
- (id)init
{
    ...
    if (self) {
        ...
        _optionCategories[@(AIRSTASHMP_OPT_CATEGORY_PLAYER)] = _playerOptions;
        _optionCategories[@(AIRSTASHMP_OPT_CATEGORY_FORMAT)] = _formatOptions;
        _optionCategories[@(AIRSTASHMP_OPT_CATEGORY_CODEC)]  = _codecOptions;
        _optionCategories[@(AIRSTASHMP_OPT_CATEGORY_SWS)]    = _swsOptions;
    }
    return self;
}

- (void)applyTo:(AirStashMediaPlayer *)mediaPlayer
{
