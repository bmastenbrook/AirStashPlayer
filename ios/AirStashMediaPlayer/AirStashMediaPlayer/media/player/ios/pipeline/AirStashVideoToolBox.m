...
#include "AirStashVideoToolBox.h"
...
#define AIRSTASH_VTB_FCC_AVC    SDL_FOURCC('C', 'c', 'v', 'a')
#define AIRSTASH_VTB_FCC_ESD    SDL_FOURCC('s', 'd', 's', 'e')
#define AIRSTASH_VTB_FCC_AVC1   SDL_FOURCC('1', 'c', 'v', 'a')
...
VideoToolBoxContext* init_videotoolbox(FFPlayer* ffp, AVCodecContext* ic)
{
    ...
    switch (profile) {
        case FF_PROFILE_H264_HIGH_10:
            if ([AirStashDeviceModel currentModel].rank >= kAirStashDeviceRank_AppleA7Class) {
                // Apple A7 SoC
    ...
    switch (codec) {
        case AV_CODEC_ID_H264:
            ...
            if (extradata[0] == 1) {
                ...
                context_vtb->m_fmt_desc = CreateFormatDescriptionFromCodecData(AIRSTASH_VTB_FCC_AVC1, width, height, extradata, extrasize,  AIRSTASH_VTB_FCC_AVC);
