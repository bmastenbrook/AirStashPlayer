...
#define DEFAULT_HIGH_WATER_MARK_IN_BYTES        (256 * 1024 * 4)
...
typedef struct FFPlayer {
    ...
    SDL_Aout *aout;
    SDL_Vout *vout;
    struct AirStashFF_Pipeline *pipeline;
    struct AirStashFF_Pipenode *node_vdec;
    int sar_num;
    int sar_den;
