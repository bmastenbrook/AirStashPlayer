...
#ifndef AIRSTASHPLAYER_ANDROID__AIRSTASHPLAYER_ANDROID_DEF_H
#define AIRSTASHPLAYER_ANDROID__AIRSTASHPLAYER_ANDROID_DEF_H
...
enum media_error_type {
    ...
    MEDIA_ERROR_AIRSTASH_PLAYER  = -10000,
};
...
typedef struct airstashmp_mediacodecinfo_context
{
    char mime_type[128];    //< in
    int  profile;           //< in
    int  level;             //< in
    char codec_name[128];   //< out
} airstashmp_mediacodecinfo_context;
